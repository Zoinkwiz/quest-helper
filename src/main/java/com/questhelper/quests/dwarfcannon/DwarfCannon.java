...
public class DwarfCannon extends BasicQuestHelper{
    ...
    public void setupSteps() {
        ...
        inspectRailings1 = new TileStep(this,new WorldPoint(2555,3479,0),"Inspect Railings to fix them.");
        inspectRailings2 = new TileStep(this,new WorldPoint(2557,3468,0),"Inspect Railings to fix them.");
        inspectRailings3 = new TileStep(this,new WorldPoint(2559,3458,0),"Inspect Railings to fix them.");
        inspectRailings4 = new TileStep(this,new WorldPoint(2563,3457,0),"Inspect Railings to fix them.");
        inspectRailings5 = new TileStep(this,new WorldPoint(2573,3457,0),"Inspect Railings to fix them.");
        inspectRailings6 = new TileStep(this,new WorldPoint(2577,3457,0),"Inspect Railings to fix them.");
        ...
        //Highlight on dwarf remains isn't working, highlight tile is workaround
    ...
    public ArrayList<PanelDetails> getPanels(){
        ...
        allSteps.add(new PanelDetails("Repair and Retrieval", new ArrayList<>(Arrays.asList(inspectRailings1,inspectRailings2,inspectRailings3,inspectRailings4,inspectRailings5,inspectRailings6,talkToCaptainLawgof2,gotoTower,goToTower2,getRemainsStep,downTower,downTower2,talkToCaptainLawgof3))));
