...
class CastleDrakan
{
	...
	void setupRequirements()
	{
		...
		inLobbyF0.setDisplayText("inLobbyF0");
		inDiningRoomF0 = and(onF0, inDiningRoom);
		inDiningRoomF0.setDisplayText("inDiningRoomF0");
		inThroneRoomF0 = and(onF0, inThroneRoom);
		inThroneRoomF0.setDisplayText("inThroneRoomF0");
		inRoomSouthOfThroneRoom = castleDrakanRoom.eq(4);
		inRoomSouthOfThroneRoom.setDisplayText("inRoomSouthOfThroneRoom");
		inStorageRoom = castleDrakanRoom.eq(6);
		inStorageRoom.setDisplayText("inStorageRoom");
		inStudy = castleDrakanRoom.eq(7);
		inStudy.setDisplayText("inStudy");
		inHallwayWestOfDiningRoom = castleDrakanRoom.eq(8);
		inHallwayWestOfDiningRoom.setDisplayText("inHallwayWestOfDiningRoom");
		inEmblemGallery = castleDrakanRoom.eq(13);
		inEmblemGallery.setDisplayText("inEmblemGallery");
		inWestChapelHallway = castleDrakanRoom.eq(15);
		inWestChapelHallway.setDisplayText("inWestChapelHallway");
		inNorthChapelHallway = castleDrakanRoom.eq(17);
		inNorthChapelHallway.setDisplayText("inNorthChapelHallway");
		inKitchen = castleDrakanRoom.eq(11);
		inKitchen.setDisplayText("inKitchen");
		inLarder = castleDrakanRoom.eq(10);
		inLarder.setDisplayText("inLarder");
		inEmblemGalleryHallway = castleDrakanRoom.eq(12);
		inEmblemGalleryHallway.setDisplayText("inEmblemGalleryHallway");
		inLobbyBasementHallway = castleDrakanRoom.eq(48);
		inLobbyBasementHallway.setDisplayText("inLobbyBasementHallway");
		inLobbyBasementVenator = castleDrakanRoom.eq(49);
		inLobbyBasementVenator.setDisplayText("inLobbyBasementVenator");
		inBasementPrison = castleDrakanRoom.eq(51);
		inBasementPrison.setDisplayText("inBasementPrison");

		inDiningRoomF1 = and(inDiningRoom, onF1);
		inDiningRoomF1.setDisplayText("inDiningRoomF1");
		inThroneRoomF1 = and(inThroneRoom, onF1);
		inThroneRoomF1.setDisplayText("inThroneRoomF1");
		inVanesculasStudy = castleDrakanRoom.eq(23);
		inVanesculasStudy.setDisplayText("inVanesculasStudy");
		inVanesculasChamber = castleDrakanRoom.eq(24);
		inVanesculasChamber.setDisplayText("inVanesculasChamber");
		inDrakanEmblemRoomSouthOfExplosiveRoom = castleDrakanRoom.eq(25);
		inDrakanEmblemRoomSouthOfExplosiveRoom.setDisplayText("inDrakanEmblemRoomSouthOfExplosiveRoom");
		inExplosiveRoom = castleDrakanRoom.eq(28);
		inExplosiveRoom.setDisplayText("inExplosiveRoom");
		inHallwayEastOfExplosiveRoom = castleDrakanRoom.eq(31);
		inHallwayEastOfExplosiveRoom.setDisplayText("inHallwayEastOfExplosiveRoom");
		inLobbyF1 = and(onF1, inLobby);
		inLobbyF1.setDisplayText("inLobbyF1");
		inHallwayNorthOfLobby = castleDrakanRoom.eq(34);
		inHallwayNorthOfLobby.setDisplayText("inHallwayNorthOfLobby");
		inVanesculasHallway = castleDrakanRoom.eq(35);
		inVanesculasHallway.setDisplayText("inVanesculasHallway");
		inRanisHallway = castleDrakanRoom.eq(36);
		inRanisHallway.setDisplayText("inRanisHallway");
		inRanisParlour = castleDrakanRoom.eq(26);
		inRanisParlour.setDisplayText("inRanisParlour");
		inVenatorRoom = castleDrakanRoom.eq(37);
		inVenatorRoom.setDisplayText("inVenatorRoom");

		inHallway5 = castleDrakanRoom.eq(18);
		inHallway5.setDisplayText("inHallway5");
		inBedroomAboveThroneRoom = castleDrakanRoom.eq(20);
		inBedroomAboveThroneRoom.setDisplayText("inBedroomAboveThroneRoom");
		inFirstFloorEastStaircase = castleDrakanRoom.eq(22);
		inFirstFloorEastStaircase.setDisplayText("inFirstFloorEastStaircase");
		inGroundFloorEastStaircase = castleDrakanRoom.eq(5);
		inGroundFloorEastStaircase.setDisplayText("inGroundFloorEastStaircase");
		inThroneRoomStorageRoom = castleDrakanRoom.eq(9);
		inThroneRoomStorageRoom.setDisplayText("inThroneRoomStorageRoom");
		inCrescentDoorRoom = castleDrakanRoom.eq(27);
		inCrescentDoorRoom.setDisplayText("inCrescentDoorRoom");
		inSolidDoorStoreRoom = castleDrakanRoom.eq(41);
		inSolidDoorStoreRoom.setDisplayText("inSolidDoorStoreRoom");
		inBasementStoreRoom = castleDrakanRoom.eq(50);
		inBasementStoreRoom.setDisplayText("inBasementStoreRoom");
		inOrnateKnifeRoom = castleDrakanRoom.eq(21);
		inOrnateKnifeRoom.setDisplayText("inOrnateKnifeRoom");
		inGuestChamberStoreroom = castleDrakanRoom.eq(46);
		inGuestChamberStoreroom.setDisplayText("inGuestChamberStoreroom");
		inRoomOutsideGuestChamberStoreroom = castleDrakanRoom.eq(38);
		inRoomOutsideGuestChamberStoreroom.setDisplayText("inRoomOutsideGuestChamberStoreroom");
		inVenatorPuzzleRoom = castleDrakanRoom.eq(39);
		inVenatorPuzzleRoom.setDisplayText("inVenatorPuzzleRoom");
		inVenatorPuzzleRoomLibrary = castleDrakanRoom.eq(44);
		inVenatorPuzzleRoomLibrary.setDisplayText("inVenatorPuzzleRoomLibrary");
		inSmallHallway = castleDrakanRoom.eq(33);
		inSmallHallway.setDisplayText("inSmallHallway");
		inRoomWithIvanAndVenator = castleDrakanRoom.eq(29);
		inRoomWithIvanAndVenator.setDisplayText("inRoomWithIvanAndVenator");
		inSecretRoom = castleDrakanRoom.eq(32);
		inSecretRoom.setDisplayText("inSecretRoom");
		inBottleRoom = castleDrakanRoom.eq(16);
		inBottleRoom.setDisplayText("inBottleRoom");
		inChapelLibrary = castleDrakanRoom.eq(14);
		inChapelLibrary.setDisplayText("inChapelLibrary");
		inServantsQuarters = castleDrakanRoom.eq(30);
		inServantsQuarters.setDisplayText("inServantsQuarters");
		inRoomAboveStudy = castleDrakanRoom.eq(19);
		inRoomAboveStudy.setDisplayText("inRoomAboveStudy");
		inSolidKeyRoom = castleDrakanRoom.eq(40);
		inSolidKeyRoom.setDisplayText("inSolidKeyRoom");
		inSolidDoorHallway = castleDrakanRoom.eq(45);
		inSolidDoorHallway.setDisplayText("inSolidDoorHallway");
		inLaboratory = castleDrakanRoom.eq(42);
		inLaboratory.setDisplayText("inLaboratory");
		inLaboratoryStorageRoom = castleDrakanRoom.eq(43);
		inLaboratoryStorageRoom.setDisplayText("inLaboratoryStorageRoom");
		...
		needToStartThroneRoomPuzzle.setDisplayText("needToStartThroneRoomPuzzle");
		needToPullBusts = throneRoomPuzzleB.eq(1);
		needToPullBusts.setDisplayText("needToPullBusts");
		needToGetKey = throneRoomPuzzleB.eq(2);
		needToGetKey.setDisplayText("needToGetKey");
		doneWithThroneRoomPuzzle = throneRoomPuzzleB.eq(3);
		doneWithThroneRoomPuzzle.setDisplayText("doneWithThroneRoomPuzzle");
		...
		hasUsedNewMoonKey.setDisplayText("hasUsedNewMoonKey");
		usedSolidKey = new VarplayerRequirement(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_4, true, 5);
		usedSolidKey.setDisplayText("usedSolidKey");

		openedLobbyHalfMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_1, 3);
		openedLobbyHalfMoonDoor.setDisplayText("openedLobbyHalfMoonDoor");
		openedDiningHalfMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_1, 21);
		openedDiningHalfMoonDoor.setDisplayText("openedDiningHalfMoonDoor");
		openedThroneHalfMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_1, 27);
		openedThroneHalfMoonDoor.setDisplayText("openedThroneHalfMoonDoor");
		openedGalleryCrescentDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_2, 13);
		openedGalleryCrescentDoor.setDisplayText("openedGalleryCrescentDoor");
		openedKitchenCrescentDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_2, 11);
		openedKitchenCrescentDoor.setDisplayText("openedKitchenCrescentDoor");
		openedBasementCrescentDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_4, 9);
		openedBasementCrescentDoor.setDisplayText("openedBasementCrescentDoor");
		openedDiningGibbousDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_1, 9);
		openedDiningGibbousDoor.setDisplayText("openedDiningGibbousDoor");
		openedVenatorPuzzleGibbousDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_3, 27);
		openedVenatorPuzzleGibbousDoor.setDisplayText("openedVenatorPuzzleGibbousDoor");
		openedGuestStoreroomGibbousDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_3, 23);
		openedGuestStoreroomGibbousDoor.setDisplayText("openedGuestStoreroomGibbousDoor");
		openedExplosiveHallwayGibbousDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_1, 23);
		openedExplosiveHallwayGibbousDoor.setDisplayText("openedExplosiveHallwayGibbousDoor");
		openedCrescentDoorRoomDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_3, 5);
		openedCrescentDoorRoomDoor.setDisplayText("openedCrescentDoorRoomDoor");
		openedBottleRoomFullMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_2, 19);
		openedBottleRoomFullMoonDoor.setDisplayText("openedBottleRoomFullMoonDoor");
		openedRoomAboveStudyFullMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_1, 29);
		openedRoomAboveStudyFullMoonDoor.setDisplayText("openedRoomAboveStudyFullMoonDoor");
		openedSolidKeyRoomFullMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_4, 1);
		openedSolidKeyRoomFullMoonDoor.setDisplayText("openedSolidKeyRoomFullMoonDoor");
		openedStockpileFullMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_3, 29);
		openedStockpileFullMoonDoor.setDisplayText("openedStockpileFullMoonDoor");
		openedBedroomFullMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_2, 23);
		openedBedroomFullMoonDoor.setDisplayText("openedBedroomFullMoonDoor");
		openedChapelLibraryFullMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_2, 21);
		openedChapelLibraryFullMoonDoor.setDisplayText("openedChapelLibraryFullMoonDoor");
		openedNorthChapelFullMoonDoor = openedDoor(VarPlayerID.CASTLE_DRAKAN_DOOR_STATUS_2, 17);
		openedNorthChapelFullMoonDoor.setDisplayText("openedNorthChapelFullMoonDoor");
		
		usedUpHalfMoonKey = and(openedLobbyHalfMoonDoor, openedDiningHalfMoonDoor, openedThroneHalfMoonDoor);
		usedUpHalfMoonKey.setDisplayText("usedUpHalfMoonKey");
		usedUpGibbousMoonKey = and(openedDiningGibbousDoor, openedExplosiveHallwayGibbousDoor, openedGuestStoreroomGibbousDoor, openedVenatorPuzzleGibbousDoor);
		usedUpGibbousMoonKey.setDisplayText("usedUpGibbousMoonKey");
		openedAHalfMoonDoor = or(openedLobbyHalfMoonDoor, openedDiningHalfMoonDoor, openedThroneHalfMoonDoor);
		openedAHalfMoonDoor.setDisplayText("openedAHalfMoonDoor");
		usedUpFullMoonKey = and(openedBottleRoomFullMoonDoor, openedRoomAboveStudyFullMoonDoor, openedSolidKeyRoomFullMoonDoor, openedStockpileFullMoonDoor, openedBedroomFullMoonDoor, openedChapelLibraryFullMoonDoor, openedNorthChapelFullMoonDoor);
		usedUpFullMoonKey.setDisplayText("usedUpFullMoonKey");
