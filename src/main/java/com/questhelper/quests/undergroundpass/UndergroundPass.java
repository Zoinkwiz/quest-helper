...
public class UndergroundPass extends BasicQuestHelper {
    ...
    QuestStep goToArdougneCastleFloor2, talkToKingLathas, goDownCastleStairs, enterWestArdougne, talkToKoftik,
            ...
            useClothOnArrow, lightArrow, wieldLitArrow, walkNorthEastOfBridge, shootBridgeRope, collectPlank,
    ...
    private void setupItemReqs() {
        ...
        tinderbox = new ItemRequirement("Tinderbow", ItemID.TINDERBOX);
        tinderboxHighlight = new ItemRequirement("Tinderbow", ItemID.TINDERBOX);
        ...
        litArrow = new ItemRequirement("Lit Arrow", ItemID.BRONZE_FIRE_ARROW_LIT, 1, true);
    ...
    private void setupZones() {
        ...
        westArdougne = new Zone(new WorldPoint(2433, 3264, 0), new WorldPoint(2557, 3337, 0));
    ...
    public void setupSteps() {
        ...
        talkToKingLathas.addDialogStep("I am. What's our plan?");
        talkToKingLathas.addDialogStep("Yes.");
        talkToKingLathas.addSubSteps(goToArdougneCastleFloor2);

        goDownCastleStairs = new ObjectStep(this, ObjectID.STAIRCASE_15648, "Talk to Koftik in West Ardougne.");
        enterWestArdougne = new ObjectStep(this, ObjectID.ARDOUGNE_WALL_DOOR_8739, "Talk to Koftik in West Ardougne.");
        ...
        enterTheDungeon = new ObjectStep(this, ObjectID.CAVE_ENTRANCE_3213, new WorldPoint(2434, 3314, 0), "Enter the dungeon.");
        ...
        walkNorthEastOfBridge = new TileStep(this, new WorldPoint(2447, 9722, 0), "Walk to the room north of Koftik.", litArrow);
        shootBridgeRope = new ObjectStep(this, ObjectID.GUIDE_ROPE, "Wield a lit arrow and shoot the guide-rope.", litArrow);
    ...
    public Map<Integer, QuestStep> loadSteps() {
        ...
        crossTheBridge.addStep(new Conditions(new Conditions(LogicType.OR, isBeforeBridge, isNorthEastOfBridge), haveLitArrow), wieldLitArrow);
