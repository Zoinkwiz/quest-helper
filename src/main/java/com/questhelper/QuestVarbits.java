...
public enum QuestVarbits
{
	...
	BALLOON_TRANSPORT_CRAFTING_GUILD(2871), // KNOWN
	BALLOON_TRANSPORT_VARROCK(2872), // KNOWN
	BALLOON_TRANSPORT_CASTLE_WARS(2873),
	BALLOON_TRANSPORT_GRAND_TREE(2870), // KNOWN
